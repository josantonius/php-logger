...
namespace Josantonius\Logger\Test;
...
final class LoggerTest extends TestCase { 
    ...
    public function testStartLogging() {
        ...
        $this->assertContains('Josantonius\Logger\Logger',
    ...
    public function testLoadScript() {
        ...
        $this->assertContains($this->JS . 'logger.min-',
    ...
    public function testLoadStyles() {
        ...
        $this->assertContains($this->CSS . 'logger.min-',
