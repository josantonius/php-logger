...
class Logger { 
    ...
    public function __construct($path = null, $filename = null, $logNumber = 200, $ip = null, $states = null) {
        ...
        $this->_setServerInfo($ip);

        $this->_setStates($states);

        $this->_setFilePath($path, $filename);
    ...
    public static function save($type, $code, $msg, $line, $file, $data=0) {
        ...
        self::_setLogInfo($type, $code, $msg, $line, $file);
    ...
    public static function script($url) {
        ...
        return self::_setFile('logger.min', 'script', $url);
    }
    ...
    public static function style($url) {
        ...
        return self::_setFile('logger.min', 'style', $url);
    }
     ...
     * @return string → file url
     */
    private static function _setFile($filename, $type, $pathUrl) {
     ...
     * @return void
     */
    private function _setServerInfo($ip) {
     ...
     * @return void
     */
    private static function _setLogInfo($type, $code, $msg, $line, $file) {
     ...
     * @return void
     */
    private function _setFilePath($path, $filename) {
     ...
     * @return void
     */
    private function _setStates($states) {
